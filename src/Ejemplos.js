...
//Declarar o implementar clasica
//parametros opcionales
function nombre(parametro, parametro2, otro) {
  let suma = parametro + parametro2;
  return suma; //opcional
}

//Declarar o implementar arrow function
let mi_funcion = (numero, numero2) => {
  let resta = numero - numero2; // solo vive en el bloque de la funcion
  return resta; //opcional si no lo lleva devuelve un undefined
};
...
let props = {
  prop1: "hola",
  prop2: "mundo",
  prop3: <OtroComponente></OtroComponente>,
};

<MiComponente
  prop1={"hola"}
  prop2={"mundo"}
  props3={<OtroComponente></OtroComponente>}
></MiComponente>;

function MiComponente({ prop1 }) {
  let primerValor = props1;
  return <></>;
}
